...
public class Client {
	...
	public static void main(String[] args) throws IOException, BiffException {
		...
		SocketHandler mySocket = new SocketHandler(host, port, verbose);// inicializa un socket con el puerto indicado 3001--3010
		
		String inMsg;

		Controller driver = load(args[0]); // CArga por su nombre la clase que gestiona el conductor
			...
			while (true) {
				...
				if (inMsg != null) {
					...
					if (currStep < maxSteps || maxSteps == 0)
						// Manda los mensajes al conductor y recibe la acción volante, marcha , freno y  aceleración
